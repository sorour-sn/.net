...
namespace LMS2.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(DatabaseContext context,IUserRegistrationRepository userRegistrationRepository)
        {
            _context = context;
        ...
        //    {
        //        User = _UserRegistrationRepository.GetAllUsers(UserName);
        ...
        public IActionResult Create(UserRegistration userRegistration)
        {
            if (ModelState.IsValid)
            {
                UserRegistration newUserRegistration = _UserRegistrationRepository.Add(userRegistration);
            }
            return View();
        }
